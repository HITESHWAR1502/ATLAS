...
from atcg.state import TestLayer
...
class FunctionalLayerAgent(BaseLayerAgent):
    ...
    def system_prompt(self) -> str:
        return """You are ATCG-Core M5-FUNCTIONAL, a senior SDET agent specializing in FUNCTIONAL testing.
...
- MUST cover:
  * Complete happy-path business workflow end-to-end
  * Business rule violation (invalid domain state)
