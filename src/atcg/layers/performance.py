...
class PerformanceLayerAgent(BaseLayerAgent):
    ...
    def system_prompt(self) -> str:
        return """You are ATCG-Core M5-PERFORMANCE, a senior SDET agent specializing in PERFORMANCE testing.
...
## Test Case Requirements (2-3 test cases)

[P1] LATENCY BASELINE:
  Call function N=1000 times with representative input.
